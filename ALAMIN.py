...
----------------------------------------------
 ...
 For Haters:  𝗡𝗮 𝗫𝘂𝗱𝗵𝗶 𝗙𝗺𝘇 𝗡𝗮 𝗫𝘂𝗱𝗵𝗶 𝗖𝗲𝗹𝗲𝗯𝗿𝗲𝘁𝘆 𝗢𝗸𝗵__))♥✨🍒
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        tks = ("Hi ROLEX Sir, I Need To Buy Your Paid ROLEX PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python ROLEX.py')
